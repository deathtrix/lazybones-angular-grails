= Lazybones Template for AngularJS Grails 3.0
...
== This is a port of https://github.com/craigburke/lazybones-angular-grails[lazybones-angular-grails] for Grails 3.0
